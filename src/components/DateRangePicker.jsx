...
const DateRangePicker = ({ onDateRangeChange }) => {
  ...
  return (
    <div className={`bg-white p-5 rounded-lg shadow-md border ${isActive ? 'border-indigo-300' : 'border-neutral-200'} transition-colors`}>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full p-2 border border-neutral-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
            />
          </div>
          <div>
        ...
        <div className="flex space-x-3 pt-2">
          ...
          >
           ...
           <button
            onClick={handleReset}
            className="flex-1 bg-neutral-200 hover:bg-neutral-300 text-secondary py-2 px-4 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-500 flex items-center justify-center"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Quick date range options */}
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <button 
              ...
              className="bg-neutral-100 hover:bg-neutral-200 text-secondary py-1 px-2 rounded transition-colors"
            >
              Last 7 days
            </button>
            <button 
