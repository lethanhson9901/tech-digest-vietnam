...
import { useWeeklyTechReports } from '../hooks/useWeeklyTechReports';

const WeeklyTechReportsArchivePage = () => {
  const [showFilters, setShowFilters] = useState(false);
  const [isInitialLoad, setIsInitialLoad] = useState(true);
  
  const { reports, total: totalCount, loading: isLoading, error, fetchReports } = useWeeklyTechReports({ autoFetch: false });
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-white animate-slideIn flex items-center">
                ...
                Tạp chí Công nghệ hằng tuần Archive
              </h1>
              <p className="text-blue-100 mt-2 animate-slideIn" style={{ animationDelay: '0.1s' }}>
                Khám phá {totalCount || 'tất cả'} số báo Tạp chí Công nghệ hàng tuần
              </p>
            </div>
          ...
          <div className="p-6">
            <div className="mb-6">
              <SearchBar 
                ...
                placeholder="Tìm kiếm tạp chí công nghệ..."
              />
            </div>
            ...
            {isInitialLoad ? (
              ...
              <div className="animate-fadeIn">
                <ListViewReportsList 
                  ...
                  contentType="weekly-tech-reports"
                />
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-6 animate-slideIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{totalCount || reports.length}</div>
                <div className="text-sm text-muted">Tổng số báo</div>
              </div>
              <div className="text-center">
...
export default WeeklyTechReportsArchivePage;
